...
import dev.mcclease.loginbackend.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = appUserService.signUpUser(
                new AppUser(request.getFirstName(), request.getLastName(), request.getEmail(),
    ...
    //This was mostly from a template I found on the interwebs.
